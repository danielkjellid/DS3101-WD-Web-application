...
class Breadcrumb {
    ...
    /* Method for generatign breadcrumbs on site */
    generateBreadcrumb(container) {

        /* set variable as 0 because it may change depending on the if statement bellow */
        let breadcrumb = 0;

        /* if the body contains the edit class (used in edit.html) */
        if ($('body.edit')[0]) {

            /* reset the breadcrumb variable */
            breadcrumb = `<div class="breadcrumbs flex items-center">
                            <!-- link to take you to previous level -->
                            <a href="cards.html" class="flex items-center">
                                <!-- preserves UD by having an icon with a dark background, and even darker icon -->
                                <svg class="icn" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <!-- Spans for showing path and current location -->
                        ...
                        <!-- anchor for deleting card, and the redirect to main page -->
        ...
        /* if the body contains the cases class (used in cases.html) */
            ...
            breadcrumb = `<div class="breadcrumbs flex items-center">
                        ...
                        <button type="button" id="add-card" class="breadcrumbs-action">
                            <svg class="icn" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <circle id="Oval" fill="#000000" cx="10" cy="10" r="10"></circle>
        ...
        /* append the breadcrumb variable to the container set in the calling of the method */
