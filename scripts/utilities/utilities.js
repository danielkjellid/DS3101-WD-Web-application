...
class Utility {
    ...
    generateCard(obj, container) {
        ...
        if($('body.overview')[0]) {
            ...
            generateCard = `<article class="case-card">
            <div>
            ...
            /* card structure, formatted for readability */
                ...
                <div class="case-card-action flex items-center justify-between">
                    ...
                    <div class="flex justify-end items-center case-card-action-icn-container">
                        <svg class="icn mr-2 actions-bar" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
